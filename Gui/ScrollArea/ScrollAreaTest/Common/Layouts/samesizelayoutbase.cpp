...
//    return itemList.value(index);
    ...
    WLog(" !!! NOT IMPLEMENTED (DynamicDelegateBasedHighPerformanceSameSizeLayoutBase::itemAt)");
#endif
    return NULL;
}
...
#ifdef ENABLE_INTERNAL_NOT_IMPLEMENTED_WARNING_LOGGING
    WLog(" !!! NOT IMPLEMENTED (DynamicDelegateBasedHighPerformanceSameSizeLayoutBase::takeAt)");
#endif
