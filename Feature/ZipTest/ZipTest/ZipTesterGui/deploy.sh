...
#Variables
BUILD_PATH="./../../ZipTest-build-desktop"
QT_GCC_PATH="QtSDK/Desktop/Qt/4.8.0/gcc"
BUILD_DIR="ZipTesterGui"
QUAZIP_PATH="3rdParty/quazip"
APPLICATION_BUNDLE="ZipTesterGui.app"
EXECUTABLE_NAME="ZipTesterGui"
