...
class ResourceDownloadStreamToFile : public QObject, public CommunicationResourceGateway::CommunicationResourceGatewayDelegate
{
    Q_OBJECT
public:
    explicit ResourceDownloadStreamToFile(CommunicationResourceGateway::CommunicationResourceGatewayCacheDelegate *commResourceGatewayCacheDelegate, unsigned int maxParallelRequestsCount = 5, QObject *parent = 0);
