...
class ResourceDownloadStreamToMemory : public QObject, public CommunicationResourceGateway::CommunicationResourceGatewayDelegate
{
    Q_OBJECT
public:
    explicit ResourceDownloadStreamToMemory(CommunicationResourceGateway::CommunicationResourceGatewayCacheDelegate *commResourceGatewayCacheDelegate, unsigned int maxParallelRequestsCount = 5, QObject *parent = 0);
