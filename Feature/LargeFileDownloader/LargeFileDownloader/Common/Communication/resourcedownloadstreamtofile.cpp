...
ResourceDownloadStreamToFile::ResourceDownloadStreamToFile(CommunicationResourceGateway::CommunicationResourceGatewayCacheDelegate *commResourceGatewayCacheDelegate, unsigned int maxParallelRequestsCount, QObject *parent) :
    QObject(parent)
{
...
void ResourceDownloadStreamToFile::_streamToFileFailedWithError(QString filePath, QString errorMessage)
{
    ...
    if(relatedUrl.isEmpty()) {
        ...
        Q_EMIT resourceDownloadFailedForUrl(relatedUrl);
    }
...
void ResourceDownloadStreamToFile::_streamToFileFinished(QString filePath)
{
    ...
    if(relatedUrl.isEmpty()) {
        ...
        Q_EMIT resourceDownloadFinishedWithSuccess(relatedUrl);
    }
